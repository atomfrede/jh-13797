...
export class QuestionService {
  ...
  update(question: IQuestion): Observable<EntityResponseType> {
    return this.http.put<IQuestion>(`${this.resourceUrl}/${getQuestionIdentifier(question) as string}`, question, { observe: 'response' });
  }

  partialUpdate(question: IQuestion): Observable<EntityResponseType> {
    return this.http.patch<IQuestion>(`${this.resourceUrl}/${getQuestionIdentifier(question) as string}`, question, {
      observe: 'response',
    });
  }
