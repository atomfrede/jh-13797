...
public class ExamResource {
     ...
     */
    @PutMapping("/exams/{id}")
    public ResponseEntity<Exam> updateExam(@PathVariable(value = "id", required = false) final String id, @RequestBody Exam exam)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, exam.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Exam> partialUpdateExam(@PathVariable(value = "id", required = false) final String id, @RequestBody Exam exam)
        throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, exam.getId()));
    }
