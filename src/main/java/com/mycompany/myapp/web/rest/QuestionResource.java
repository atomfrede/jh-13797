...
public class QuestionResource {
    ...
    public ResponseEntity<Question> updateQuestion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, question.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Question> partialUpdateQuestion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, question.getId())
        );
    }
